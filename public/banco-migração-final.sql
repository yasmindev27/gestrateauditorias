...
CREATE TABLE IF NOT EXISTS public.acoes_incidentes (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.agenda_destinatarios (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.analises_incidentes (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  incidente_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.asos_seguranca (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.assistencia_social_documentos (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.assistencia_social_encaminhamentos (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  atendimento_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.ativos_disponibilidade (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.auditoria_formularios_config (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  tipo text NOT NULL,
  nome text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.auditoria_perguntas_config (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.auditoria_secoes_config (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.auditorias_qualidade (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.auditorias_seguranca_paciente (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  tipo text NOT NULL,
  data_auditoria date NOT NULL,
  setor text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.avaliacoes_prontuarios (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  prontuario_id uuid,
...
CREATE TABLE IF NOT EXISTS public.cadastros_inconsistentes (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  prontuario_id uuid,
  numero_prontuario text,
...
CREATE TABLE IF NOT EXISTS public.cafe_litro_diario (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  data date NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.chamados_materiais (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  chamado_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.chat_mensagens_lidas (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.chat_moderacao_logs (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  mensagem_id uuid,
  user_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.colaboradores_restaurante (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  nome text NOT NULL,
  matricula text,
  setor text,
...
CREATE TABLE IF NOT EXISTS public.controle_vigencia (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  categoria text NOT NULL,
  tipo_documento text NOT NULL,
  descricao text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.enfermagem_configuracoes (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  chave text NOT NULL,
  valor text NOT NULL,
  descricao text,
...
CREATE TABLE IF NOT EXISTS public.enfermagem_escalas (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.enfermagem_trocas (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.enfermagem_trocas_historico (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.epis_seguranca (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  usuario_id uuid NOT NULL,
  usuario_nome text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.escala_tec_enf_dias (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  profissional_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.escala_tec_enf_profissionais (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  escala_id uuid NOT NULL,
  nome text NOT NULL,
  coren text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.escalas_laboratorio (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.escalas_medicos (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  profissional_id uuid NOT NULL,
  data_plantao date NOT NULL,
  hora_inicio time without time zone NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.escalas_tec_enfermagem (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  mes integer NOT NULL,
  ano integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.ferramentas_modulo (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  modulo_id uuid,
  codigo text NOT NULL,
  nome text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.formulario_permissoes (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  formulario_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.gerencia_planos_acao (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  titulo text NOT NULL,
  descricao text,
  setor text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.gerencia_planos_historico (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.incidentes_nsp (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.justificativas_extensao_jornada (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.lms_inscricoes (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.lms_materiais (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  treinamento_id uuid NOT NULL,
  titulo text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.lms_quiz_perguntas (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  treinamento_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.lms_tentativas_quiz (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.lms_treinamentos (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  titulo text NOT NULL,
  descricao text,
  objetivo text,
...
CREATE TABLE IF NOT EXISTS public.manutencoes_execucoes (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  preventiva_id uuid,
  ativo_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nir_colaboradores (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  nome text NOT NULL,
  ativo boolean NOT NULL DEFAULT true,
  created_at timestamp with time zone NOT NULL DEFAULT now(),
...
CREATE TABLE IF NOT EXISTS public.nir_registros_producao (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  colaborador text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.notificacoes_pendencias (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.notificacoes_seguranca (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  ronda_id uuid,
...
CREATE TABLE IF NOT EXISTS public.nsp_action_plans (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  indicator_id uuid,
  mes text NOT NULL,
  ano integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nsp_indicators (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  mes text NOT NULL,
  ano integer NOT NULL,
  categoria text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.passagem_plantao (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.passagem_plantao_pendencias (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.permissoes_ferramenta (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  perfil_id uuid,
  ferramenta_id uuid,
...
CREATE TABLE IF NOT EXISTS public.planos_acao_auditoria (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.porta_ecg_atendimentos (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.profissionais_documentos (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  profissional_id uuid NOT NULL,
  tipo_documento text NOT NULL,
  nome_arquivo text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.protocolo_settings (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  tipo_protocolo text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.regulacao_sus_facil (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.rondas_seguranca (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.rouparia_categorias (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  nome text NOT NULL,
  descricao text,
...
CREATE TABLE IF NOT EXISTS public.rouparia_itens (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.rouparia_movimentacoes (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.sciras_antimicrobianos (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  paciente_nome text NOT NULL,
  numero_prontuario text,
  setor text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.sciras_culturas (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.sciras_indicadores_diarios (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.sciras_notificacoes_epidemiologicas (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  numero_notificacao text NOT NULL,
  tipo text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.sciras_vigilancia_iras (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  numero_notificacao text NOT NULL,
  paciente_nome text NOT NULL,
  numero_prontuario text,
...
CREATE TABLE IF NOT EXISTS public.seg_patrimonial_conflitos (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.seg_patrimonial_danos (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.seg_patrimonial_passagem_plantao (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.seg_patrimonial_rondas (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  setor text NOT NULL,
  observacoes text,
...
CREATE TABLE IF NOT EXISTS public.seg_patrimonial_visitantes (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.solicitacoes_dieta (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  solicitante_id uuid NOT NULL,
  solicitante_nome text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.tentativas_duplicidade_refeicoes (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  tipo_pessoa text NOT NULL,
  colaborador_nome text NOT NULL,
  visitante_cpf_hash text,
...
CREATE TABLE IF NOT EXISTS public.transferencia_coordenadas (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.transferencia_intercorrencias (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  solicitacao_id uuid NOT NULL,
  descricao text NOT NULL,
  registrado_por uuid,
...
CREATE TABLE IF NOT EXISTS public.transferencia_solicitacoes (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  paciente_nome text NOT NULL,
  setor_origem text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.transferencia_veiculos (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  placa text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.uniformes_seguranca (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  usuario_id uuid NOT NULL,
  usuario_nome text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.upa_action_plans (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  indicator_id uuid,
  mes text NOT NULL,
  ano integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.upa_indicators (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  mes text NOT NULL,
  ano integer NOT NULL,
  categoria text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.vacinas_seguranca (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  usuario_id uuid NOT NULL,
  usuario_nome text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.valores_refeicoes (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  tipo_refeicao text NOT NULL,
...
DROP POLICY IF EXISTS "Quality roles can manage findings" ON public.achados_auditoria;
...
DROP POLICY IF EXISTS "Quality roles can view findings" ON public.achados_auditoria;
...
DROP POLICY IF EXISTS "Quality roles can manage actions" ON public.acoes_incidentes;
...
DROP POLICY IF EXISTS "Quality roles can view actions" ON public.acoes_incidentes;
...
DROP POLICY IF EXISTS "Admin full access agenda_destinatarios" ON public.agenda_destinatarios;
...
DROP POLICY IF EXISTS "Creator can manage recipients" ON public.agenda_destinatarios;
...
DROP POLICY IF EXISTS "Recipient can update own record" ON public.agenda_destinatarios;
...
DROP POLICY IF EXISTS "Recipient can view own record" ON public.agenda_destinatarios;
...
DROP POLICY IF EXISTS "Admin full access agenda_items" ON public.agenda_items;
...
DROP POLICY IF EXISTS "User can delete own items" ON public.agenda_items;
CREATE POLICY "User can delete own items" ON public.agenda_items FOR DELETE TO authenticated USING ((criado_por = auth.uid()));
DROP POLICY IF EXISTS "User can insert agenda_items" ON public.agenda_items;
...
DROP POLICY IF EXISTS "User can update own items" ON public.agenda_items;
CREATE POLICY "User can update own items" ON public.agenda_items FOR UPDATE TO authenticated USING ((criado_por = auth.uid()));
DROP POLICY IF EXISTS "User can view items as recipient" ON public.agenda_items;
...
DROP POLICY IF EXISTS "User can view own created items" ON public.agenda_items;
...
DROP POLICY IF EXISTS "Seguranca e admin podem atualizar alertas" ON public.alertas_seguranca;
...
DROP POLICY IF EXISTS "Usuarios autenticados podem ver alertas" ON public.alertas_seguranca;
CREATE POLICY "Usuarios autenticados podem ver alertas" ON public.alertas_seguranca FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Usuarios podem criar alertas" ON public.alertas_seguranca;
...
DROP POLICY IF EXISTS "Quality roles can manage analyses" ON public.analises_incidentes;
...
DROP POLICY IF EXISTS "Quality roles can view analyses" ON public.analises_incidentes;
...
DROP POLICY IF EXISTS "Admin, seguranca e rh_dp podem atualizar ASOs" ON public.asos_seguranca;
...
DROP POLICY IF EXISTS "Admin, seguranca e rh_dp podem deletar ASOs" ON public.asos_seguranca;
...
DROP POLICY IF EXISTS "Admin, seguranca e rh_dp podem inserir ASOs" ON public.asos_seguranca;
...
DROP POLICY IF EXISTS "Admin, seguranca e rh_dp podem ver ASOs" ON public.asos_seguranca;
...
DROP POLICY IF EXISTS "Admin and Social Assistance can insert attendances" ON public.assistencia_social_atendimentos;
...
DROP POLICY IF EXISTS "Admin and Social Assistance can update attendances" ON public.assistencia_social_atendimentos;
...
DROP POLICY IF EXISTS "Admin and Social Assistance can view attendances" ON public.assistencia_social_atendimentos;
...
DROP POLICY IF EXISTS "Admin can delete attendances" ON public.assistencia_social_atendimentos;
...
DROP POLICY IF EXISTS "Admin and Social Assistance can delete documents" ON public.assistencia_social_documentos;
...
DROP POLICY IF EXISTS "Admin and Social Assistance can insert documents" ON public.assistencia_social_documentos;
...
DROP POLICY IF EXISTS "Admin and Social Assistance can view documents" ON public.assistencia_social_documentos;
...
DROP POLICY IF EXISTS "Admin and Social Assistance can insert referrals" ON public.assistencia_social_encaminhamentos;
...
DROP POLICY IF EXISTS "Admin and Social Assistance can update referrals" ON public.assistencia_social_encaminhamentos;
...
DROP POLICY IF EXISTS "Admin and Social Assistance can view referrals" ON public.assistencia_social_encaminhamentos;
...
DROP POLICY IF EXISTS "Admin can delete referrals" ON public.assistencia_social_encaminhamentos;
...
DROP POLICY IF EXISTS "Admin and Social Assistance can insert patients" ON public.assistencia_social_pacientes;
...
DROP POLICY IF EXISTS "Admin and Social Assistance can update patients" ON public.assistencia_social_pacientes;
...
DROP POLICY IF EXISTS "Admin and Social Assistance can view patients" ON public.assistencia_social_pacientes;
...
DROP POLICY IF EXISTS "Admin can delete patients" ON public.assistencia_social_pacientes;
...
DROP POLICY IF EXISTS "Funcionários visualizam próprios atestados" ON public.atestados;
...
DROP POLICY IF EXISTS "Gestores visualizam atestados de sua equipe" ON public.atestados;
...
DROP POLICY IF EXISTS "RH_DP e Admin gerenciam atestados" ON public.atestados;
...
DROP POLICY IF EXISTS "Admin can delete ativos" ON public.ativos;
...
DROP POLICY IF EXISTS "Admin/tech can insert ativos" ON public.ativos;
...
DROP POLICY IF EXISTS "Admin/tech can update ativos" ON public.ativos;
...
DROP POLICY IF EXISTS "Authenticated users can view ativos" ON public.ativos;
...
DROP POLICY IF EXISTS "Admin/tech can insert disponibilidade" ON public.ativos_disponibilidade;
...
DROP POLICY IF EXISTS "Admin/tech can update disponibilidade" ON public.ativos_disponibilidade;
...
DROP POLICY IF EXISTS "Authenticated users can view disponibilidade" ON public.ativos_disponibilidade;
...
DROP POLICY IF EXISTS "Admin/Qualidade can manage formularios_config" ON public.auditoria_formularios_config;
...
DROP POLICY IF EXISTS "Authenticated users can read formularios_config" ON public.auditoria_formularios_config;
...
DROP POLICY IF EXISTS "Admin/Qualidade can manage perguntas_config" ON public.auditoria_perguntas_config;
...
DROP POLICY IF EXISTS "Authenticated users can read perguntas_config" ON public.auditoria_perguntas_config;
...
DROP POLICY IF EXISTS "Admin/Qualidade can manage secoes_config" ON public.auditoria_secoes_config;
...
DROP POLICY IF EXISTS "Authenticated users can read secoes_config" ON public.auditoria_secoes_config;
...
DROP POLICY IF EXISTS "Admin e gerencia podem ver todos os registros de temporalidade" ON public.auditoria_temporalidade;
...
DROP POLICY IF EXISTS "Usuarios do setor podem ver seus registros" ON public.auditoria_temporalidade;
...
DROP POLICY IF EXISTS "Quality roles can manage audits" ON public.auditorias_qualidade;
...
DROP POLICY IF EXISTS "Quality roles can view audits" ON public.auditorias_qualidade;
...
DROP POLICY IF EXISTS "Admin, Qualidade, NSP e Gestor podem visualizar auditorias" ON public.auditorias_seguranca_paciente;
...
DROP POLICY IF EXISTS "Qualidade/NSP/Admin can delete patient safety audits" ON public.auditorias_seguranca_paciente;
...
DROP POLICY IF EXISTS "Qualidade/NSP/Admin can insert patient safety audits" ON public.auditorias_seguranca_paciente;
...
DROP POLICY IF EXISTS "Qualidade/NSP/Admin can update patient safety audits" ON public.auditorias_seguranca_paciente;
...
DROP POLICY IF EXISTS "Admin and RH can manage avaliacoes" ON public.avaliacoes_desempenho;
...
DROP POLICY IF EXISTS "RH/DP e admin podem atualizar avaliacoes_experiencia" ON public.avaliacoes_experiencia;
...
DROP POLICY IF EXISTS "RH/DP e admin podem deletar avaliacoes_experiencia" ON public.avaliacoes_experiencia;
...
DROP POLICY IF EXISTS "RH/DP e admin podem inserir avaliacoes_experiencia" ON public.avaliacoes_experiencia;
...
DROP POLICY IF EXISTS "RH/DP e admin podem ver avaliacoes_experiencia" ON public.avaliacoes_experiencia;
...
DROP POLICY IF EXISTS "Apenas admin visualiza histórico" ON public.avaliacoes_historico;
...
DROP POLICY IF EXISTS "Sistema pode inserir histórico" ON public.avaliacoes_historico;
...
DROP POLICY IF EXISTS "Admins gerenciam avaliações" ON public.avaliacoes_prontuarios;
...
DROP POLICY IF EXISTS "Faturamento pode atualizar próprias avaliações" ON public.avaliacoes_prontuarios;
...
DROP POLICY IF EXISTS "Faturamento pode criar avaliações" ON public.avaliacoes_prontuarios;
...
DROP POLICY IF EXISTS "Funcionários visualizam próprio banco_horas" ON public.banco_horas;
...
DROP POLICY IF EXISTS "Gestores visualizam banco_horas de sua equipe" ON public.banco_horas;
...
DROP POLICY IF EXISTS "RH_DP e Admin gerenciam banco_horas" ON public.banco_horas;
...
DROP POLICY IF EXISTS "NIR e Admin podem ver bed_records" ON public.bed_records;
...
DROP POLICY IF EXISTS "Admin e Recepcao visualizam inconsistências" ON public.cadastros_inconsistentes;
...
DROP POLICY IF EXISTS "Admins gerenciam cadastros inconsistentes" ON public.cadastros_inconsistentes;
...
DROP POLICY IF EXISTS "Authenticated users can view inconsistencies" ON public.cadastros_inconsistentes;
...
DROP POLICY IF EXISTS "Recepcao can register inconsistencies" ON public.cadastros_inconsistentes;
...
DROP POLICY IF EXISTS "Recepcao can update inconsistencies" ON public.cadastros_inconsistentes;
...
DROP POLICY IF EXISTS "Usuários autenticados podem visualizar café litro" ON public.cafe_litro_diario;
...
DROP POLICY IF EXISTS "Usuários com role restaurante podem inserir café litro" ON public.cafe_litro_diario;
...
DROP POLICY IF EXISTS "Usuários com role restaurante podem atualizar café litro" ON public.cafe_litro_diario;
...
DROP POLICY IF EXISTS "Usuários com role restaurante podem deletar café litro" ON public.cafe_litro_diario;
